...
uniform bool KTex; checkbox[false]
...
uniform float ColorScale;  slider[0,0,1]
uniform float ColorOffset;  slider[0,0,1]
uniform bool KHeightmap; checkbox[false]
uniform float Strength;  slider[0,0,1]
uniform vec3 Strength2; slider[(-3,-3,-3),(0,0,0),(3,3,3)]

uniform vec3 K_Dir; slider[(-10,-10,-10),(0,0,0),(10,10,10)]
uniform float kHeight;  slider[0,0,1]
